#!/usr/bin/env python3
"""Replicate §4 word order with transitive verbs, SVO order (Papadimitriou et al.).

Trains a wo.LearnBrain on transitive sentences ordered Subject-Verb-Object.
After training, generates `trials` sentences and reports how many emit SVO.
"""
import argparse
import time
